                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full bg-{{ $color['name'] }}-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full bg-{{ $color['title'] }}-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full bg-{{ $color['email'] }}-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="relative">
                                ...
                                <input type="radio" name="gender" value="0" {{ old('gender') == 0 ? 'checkd' : ''}} required>男性
                                <input type="radio" name="gender" value="1" {{ old('gender') == 1 ? 'checkd' : ''}}>女性
